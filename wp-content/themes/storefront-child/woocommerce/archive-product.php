...
<?php  
				...
				wc_print_notices();
				 ...
				 <?php $args = array ('post_type' => 'product','product_cat' =>'Apple');?>
				 
	<?php $produto = new WP_Query( $args ); if ( $produto->have_posts() ) : ?>
			 
				 
<?php while ( $produto->have_posts() ) : $produto->the_post(); ?>
...
<div class="espaco">
  ...
  <div class="col-md-3 col-sm-4 col-xs-12 thumbdiv1">
...
<h3 class="h11">mais vistos</h3>
<div class="slider45"><?php echo do_shortcode('[wa-wps id=526]');?></div>
...
<?php  
				...
				wc_print_notices();
				 ...
				 <?php $args = array ('post_type' => 'product','product_cat' =>'Samsung');?>
...
<div class="slider45"><?php echo do_shortcode('[wa-wps id=696]');?></div>
	...
	<div class="row">
<div class="container-fluid">
<div class="col-xs-12 infocpr">

<h4>Celulares Novos Com Garantia </h4><br><br>


<p>

 A Digital Mobile é uma empresa brasileira com escritórios nos Estados Unidos  e Minas Gerais. Somos especializados na venda de celulares novos, Importamos celulares do Estados Unidos direto para o brasil por conta disso temos um preço abaixo dos demais no mercado brasileiro, vendemos os smartphones sem os preços abusivos de impostos que sao cobrados no brasil. Surgimos de uma necessidade verdadeira das pessoas e trabalhamos para difundir uma forma de consumo consciente e preocupada com o meio em que vivemos.  Tecnologias se tornam obsoletas e outras tantas aparecem a cada dia, e o que o povo mais quer é se atualizar.  Temos uma equipe técnica muito competente que cuida de todos os smartphones.  O que nos torna mais feliz no trabalho que exercemos e queremos propagar, é poder dar a muitas pessoas a primeira oportunidade de comprar seu smartphone barato.</p>
